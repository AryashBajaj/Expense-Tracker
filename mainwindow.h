...
public:
    ...
    void loadConfig() {
        ifstream fp("C:\\Users\\aryas\\OneDrive\\Documents\\firstGUI\\debts.txt");
        if (!fp) {
    ...
    void save() {
        ofstream fp("C:\\Users\\aryas\\OneDrive\\Documents\\firstGUI\\debts.txt");
        if (!fp) {
...
public:
    ...
    int addEdge(int from, int to, float distance, float cost) {
        try {
            ...
            adjDist[from][to] = adjDist[to][from] = distance;
            adjCost[from][to] = adjCost[to][from] =  cost;
        }
...
struct Comp {
    inline bool operator() (const vector<pair<string, int>>& a, const vector<pair<string, int>>& b) {
...
public:
    ...
    void save() {
        ofstream fp("C:\\Users\\aryas\\OneDrive\\Documents\\firstGUI\\expenses.txt");
        if (!fp) {
            qDebug() << "Cannot open file!";
            return;
        }
    ...
    void loadConfig() {
        ifstream fp("C:\\Users\\aryas\\OneDrive\\Documents\\firstGUI\\expenses.txt");
        if (!fp) {
            qDebug() << "Cannot open file!";
            return;
        }
