...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(8, 0, 800, 800));
        ...
        tableWidget_3->setGeometry(QRect(10, 50, 281, 171));
        tableWidget_4 = new QTableWidget(tab_6);
        tableWidget_4->setObjectName("tableWidget_4");
        tableWidget_4->setGeometry(QRect(320, 40, 291, 181));
        ...
        listWidget_8 = new QListWidget(tab_6);
        listWidget_8->setObjectName("listWidget_8");
        listWidget_8->setGeometry(QRect(320, 260, 256, 101));
        label_17 = new QLabel(tab_6);
        label_17->setObjectName("label_17");
        label_17->setGeometry(QRect(330, 240, 101, 16));
        ...
        layoutWidget1->setGeometry(QRect(120, 170, 311, 94));
        ...
        layoutWidget2->setGeometry(QRect(40, 10, 211, 76));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_17->setText(QCoreApplication::translate("MainWindow", "Minimum distance Path", nullptr));
